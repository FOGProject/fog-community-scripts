...
#!/bin/bash
output_log_name="rhel7_provision_output.log"
...
sudo mkdir -p /root/.ssh >> $${output_log_absolute_path} 2>&1
sudo cp /home/ec2-user/.ssh/authorized_keys /root/.ssh/authorized_keys >> $${output_log_absolute_path} 2>&1
