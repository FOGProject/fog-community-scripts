# The list of OSs.
OSs = ["debian10","centos7","centos8","rhel7","rhel8","fedora32","ubuntu18_04"]
dnsAddresses = ["debian10.fogtesting.cloud","centos7.fogtesting.cloud","centos8.fogtesting.cloud","rhel7.fogtesting.cloud","rhel8.fogtesting.cloud","fedora32.fogtesting.cloud","ubuntu18_04.fogtesting.cloud"]
